...
export const churches = [
  {
    ...
    pastor: "Dr. Kenneth Brock Sr.",
    city: "Detroit",
    state: "MI",
    zip: "48214",
    address: "3090 Cadillac Blvd, Detroit, Michigan 48214",
    denomination: "Baptist",
    worshipStyle: "Traditional",
    preachingStyle: "Biblical & practical",
    size: "Medium",
    ministries: ["Kids", "Outreach", "Community"],
    accessibility: ["Wheelchair Access"],
    online: true,
    serviceTimes: ["Sundays 10:30 AM", "Bible Study Wednesdays 6:30 PM"],
    email: "churchnewwelcome@gmail.com",
    phone: "313-844-8875",
    website: "https://newwelcomebaptistchurch.com/Home",
